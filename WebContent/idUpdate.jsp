	...
	<div class = "container">
		...
		<div class = "col-lg-4">
			 <div class = "jumbotron"  style= "padding-top : 20px;">
				<form method = "post" action = "idUpdateAction.jsp" autocomplete="off">
					<h3 style = "text-align : center">아이디 변경</h3>
					<div class = "form-group">
						<input type = "text" class = " form-control" placeholder="현재 아이디" name = "userID" maxlength = "20">
					</div>
					<div class = "form-group">
						<input type = "text" class = " form-control" placeholder="변경할 아이디" name = "userUpdateID" maxlength = "20">
					</div>
					<div class = "form-group">
